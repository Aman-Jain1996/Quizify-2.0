      ...
      <section className=" py-12 min-h-[70vh] w-[40%] mx-auto flex items-center my-12 flex-col shadow-[0px_0px_5px_0px_rgba(0,0,0,.2)] rounded-lg">
        ...
        <div className="flex w-full px-24 items-center mb-8">
          <div className="text-2xl ml-auto justify-self-end  w-full">
            <Link
              to="#"
              className="inline-block w-full text-violet-400 text-right underline underline-offset-4 hover:text-violet-500"
            >
              Forgot Password?
            </Link>
          </div>
        ...
        <button
          className="mt-8 hover:bg-violet-300 border border-violet-300 w-[80%] p-4 text-3xl font-bold rounded-md"
          onClick={() => {
            guestLoginHandler({
