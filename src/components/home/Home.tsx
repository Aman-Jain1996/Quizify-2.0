...
export const Home = () => {
  return (
    <section className="flex m-12 items-center h-[70vh]">
      <div className="mt-36 basis-2/4 p-12 flex flex-col justify-evenly">
        <p className="text-5xl font-bold max-w-[80%] m-auto leading-normal">
          "Are you a Football Fan?"
        </p>
        <p className="my-12 mx-auto max-w-[60%] text-2xl">
